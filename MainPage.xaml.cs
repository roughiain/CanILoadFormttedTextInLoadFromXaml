...
public partial class MainPage : ContentPage
{
    ...
    private static string xamlWithNoLineBreaks = "<Label LineBreakMode=\"WordWrap\"><Label.FormattedText><FormattedString><Span Text=\"Red Bold, \" TextColor=\"Red\" FontAttributes=\"Bold\" /><Span Text=\"default, \" FontSize=\"14\"/><Span Text=\"italic small.\" FontAttributes=\"Italic\" FontSize=\"12\" /></FormattedString></Label.FormattedText></Label>";

    public MainPage()
	{
		InitializeComponent();
        var label = new Label().LoadFromXaml(xamlWithNoLineBreaks);
